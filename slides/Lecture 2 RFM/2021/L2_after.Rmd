...
order<-order(table(ebeer$RFMgroup), decreasing=TRUE)
tbl<-as.data.frame(table(ebeer$RFMgroup))

bp<-barplot(tbl[order,"Freq"], xlab = "RFM segments", ylab="frequency")
axis(1, at = bp[,1], labels=tbl[order,"Var1"], cex.axis=0.7, las=2)
```
