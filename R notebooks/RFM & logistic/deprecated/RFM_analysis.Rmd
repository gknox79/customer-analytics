...
ebeer<-data.frame(as.data.set(read.csv(file.choose())))
...
![Source: [http://www.dbmarketing.com/articles/Art149.htm](http://www.dbmarketing.com/articles/Art149.htm)](./figures/RFM_nested.jpg)
...
Let's fit this model using maximum likelihood.
```{r}
